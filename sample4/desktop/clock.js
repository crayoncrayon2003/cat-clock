...
// ---------- 3. Constants (プラットフォーム別に調整) ----------
const SAFE_BOTTOM = PLATFORM.isMobile ? 100 : 48;
const MINUTE_LINE_WIDTH = PLATFORM.isMobile ? 20 : 24;
const HOUR_RADIUS = PLATFORM.isMobile ? 24 : 28;
...
function drawDebugOverlay(time) {
  ...
  ctx.fillText(`PLATFORM: ${PLATFORM.isMobile ? 'Mobile' : 'Desktop'}`, 35, 85);
  ctx.restore();
}
